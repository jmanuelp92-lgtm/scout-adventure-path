...
export const branchInfoMap: Record<string, BranchInfo> = {
  manada: {
    ...
    maximas: [
      ...
      "El lobato siempre abre los ojos y los oídos.",
      "El lobato siempre está limpio y ordenado.",
    ...
    formacionDescripcion:
      "Los lobatos forman un círculo alrededor de Akela. Es la formación principal de la Manada, inspirada en el Consejo de la Roca del Libro de las Tierras Vírgenes de Rudyard Kipling.",
    uniforme: [
    ...
    estructura:
      "La Manada se organiza en Seisenas (grupos de 6 lobatos), cada una con un Seisenero (líder) y un Sub-Seisenero. Las seisenas se identifican por colores.",
    oracionComida:
  ...
  tropa: {
    ...
    gritoDescripcion:
      "Los scouts forman en herradura. El Guía de Tropa pregunta: «Scouts, ¿están listos?». La tropa responde al unísono: «¡SIEMPRE LISTOS, PARA SERVIR!» haciendo el saludo scout con tres dedos levantados.",
    promesa:
      "Yo, por mi honor y la gracia de Dios, prometo hacer todo cuanto de mí dependa para cumplir mis deberes para con Dios y la Patria, ayudar al prójimo en toda circunstancia, trabajar por la paz y cumplir fielmente la Ley Scout.",
    ley: [
      "El scout cifra su honor en ser digno de confianza.",
      "El scout es leal.",
      "El scout es útil y ayuda a los demás sin pensar en recompensa.",
      "El scout es amigo de todos y hermano de los demás scouts sin distinción de credo, raza o clase social.",
      "El scout es cortés y caballeroso.",
      "El scout ve en la naturaleza la obra creadora de Dios; protege a los animales y a las plantas.",
      "El scout obedece sin réplica, no hace nada a medias.",
    ...
    saludo: "Saludo Scout",
    saludoDescripcion:
      "Se levantan los dedos índice, medio y anular de la mano derecha a la altura de la sien. Los tres dedos representan los tres puntos de la Promesa Scout. El pulgar cubre al meñique, simbolizando que el fuerte protege al débil.",
    formacion: "Herradura",
    formacionDescripcion:
      "Los scouts se forman en herradura (semicírculo abierto hacia el frente). Las patrullas se ubican en fila, una al lado de la otra, con el Guía de Patrulla al frente de cada una.",
    uniforme: [
      "Camisa scout del grupo",
    ...
    datosExtra: [
      ...
      },
      {
        ...
        contenido:
          "Señor y Jefe mío, que a pesar de mis debilidades me habéis escogido como guía y guardián de mis hermanos scouts. Haz que mis palabras iluminen sus pasos por el sendero de tu ley; que sepa mostrarle tu huella divina en la naturaleza que habéis creado, que sepa conducirlos de etapa en etapa hasta Ti, Dios mío.",
      },
    ],
  },
  ...
  comunidad: {
    ...
    gritoDescripcion:
      "Los caminantes forman en semicírculo. El coordinador pregunta: «Caminantes, ¿cuál es nuestro compromiso?». La comunidad responde: «¡SERVIR! ¡Siempre en camino, siempre en servicio!».",
    promesa:
      "Yo, por mi honor y la gracia de Dios, renuevo mi Promesa Scout y me comprometo a servir a mi comunidad, a buscar la verdad, a trabajar por la justicia y la paz, y a vivir fielmente la Ley Scout.",
    ley: [
      "El scout cifra su honor en ser digno de confianza.",
      "El scout es leal.",
      "El scout es útil y ayuda a los demás sin pensar en recompensa.",
    ...
    oracionComida:
      "Señor, unos tienen y no pueden, otros pueden y no tienen, nosotros que tenemos y podemos te damos gracias, Señor. Bendice estos alimentos y ayúdanos a compartir con quienes más lo necesitan.",
    datosExtra: [
      {
        titulo: "Progresión",
        contenido:
  ...
  clan: {
    ...
    grito: "Grito Rover",
    gritoDescripcion:
      "Los rovers forman en círculo tomados del hombro. El líder dice: «Rovers, ¿cuál es nuestro camino?». El clan responde: «¡SERVIR! ¡Siempre en ruta, siempre en servicio!».",
    promesa:
      "Yo, por mi honor y la gracia de Dios, me comprometo a servir lo mejor posible a Dios y a mi país, ayudar a los hombres mis hermanos en toda circunstancia y a vivir cabalmente la Ley del Rover.",
    ley: [
      "El Rover es honesto y digno de confianza.",
      "El Rover es leal durante toda la vida.",
      "El Rover convive con todos y les ayuda sin interés.",
      "El Rover es servicial y ama a su prójimo.",
      "El Rover es acogedor y combate la injusticia.",
      "El Rover ama la naturaleza y protege la vida.",
      "El Rover sabe obedecer y no hace nada a medias.",
      "El Rover es de temple y supera las dificultades.",
      "El Rover valora el trabajo y respeta el bien ajeno.",
      "El Rover cultiva su espíritu y cuida su cuerpo.",
    ],
    leyTitulo: "Ley Rover",
    oracion:
    ...
    oracionComida:
      "Señor, unos tienen y no pueden, otros pueden y no tienen, nosotros que tenemos y podemos te damos gracias, Señor. Bendice estos alimentos y danos la fuerza para servir a quienes más lo necesitan.",
    himno: {
      titulo: "Himno Rover",
